...
![Figura 1](exercicioA/Figura1.png) ([Link para melhor vizualização](https://plot.ly/~paulogil2010/13/#/)), ilustra a relação entre o tamanho da janela e o "power" alcançado de cada cenário testado. A
![Figura 2](exercicioA/Figura2.png) ([Link para melhor vizualização](https://plot.ly/~paulogil2010/15/#/)), demonstra que o Throughput e o Delay, crescem em valores de forma proporcional.
